...
<body>
    <div class="flex flex-col justify-center items-center h-screen bg-gray-100">
        <div class="m-auto box-shadow p-8 bg-white rounded-lg shadow-lg max-w-md">
            <h1 class="text-4xl font-bold text-center mb-4">Bienvenue cher Utilisateur!</h1>
            <p class="text-lg text-center mb-6">Veuillez remplir le formulaire suivant pour procéder à votre enrôlement
            </p>
